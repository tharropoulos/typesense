...
TEST_F(CollectionFacetingTest, FacetingRejectsCoercedStringAlter) {
    ...
    ASSERT_EQ("Schema change is incompatible with the type of documents already stored in this collection. "
              "Existing data for field `years` is not already an array of string. Alter does not rewrite stored documents.",
              alter_op.error());
}
